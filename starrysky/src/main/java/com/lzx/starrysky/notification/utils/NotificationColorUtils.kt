...
class NotificationColorUtils {
    ...
    fun setTitleTextColor(context: Context, remoteView: RemoteViews, viewId: Int, notification: Notification) {
    ...
    fun setContentTextColor(context: Context, remoteView: RemoteViews, viewId: Int, notification: Notification) {
        if (mNotificationColorModel == null) {
            isDarkNotificationBar(context, notification)
        }
    ...
    companion object {
        private val NOTIFICATION_TITLE = "notification_music_title"
        private val NOTIFICATION_CONTENT = "notification_music_content"

        private val COLOR_UNDEF = 987654321
        private val COLOR_THRESHOLD = 180.0
        private val NOTIFICATION_TITLE_COLOR = Color.parseColor("#de000000")
        private val NOTIFICATION_LINE2_COLOR = Color.parseColor("#8a000000")
        private val EVENTCONTENT_TITLE_COLOR = -1
        private val EVENTCONTENT_COLOR = Color.parseColor("#b3ffffff")
    }
}
